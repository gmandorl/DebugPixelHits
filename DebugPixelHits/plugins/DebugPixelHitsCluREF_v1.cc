...
class DebugPixelHitsCluREF_v1 : public edm::one::EDAnalyzer<edm::one::SharedResources> {
    public:
        explicit DebugPixelHitsCluREF_v1(const edm::ParameterSet& );
        ~DebugPixelHitsCluREF_v1();
...
DebugPixelHitsCluREF_v1::DebugPixelHitsCluREF_v1(const edm::ParameterSet& iConfig):
...
DebugPixelHitsCluREF_v1::~DebugPixelHitsCluREF_v1()
{
}


void DebugPixelHitsCluREF_v1::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    using namespace edm;
    run_  = iEvent.id().run();
    ...
    for (const reco::Candidate & candidate : *candidates) 
    {
        ...
        {           
            ...
            for (const auto & hitAndChi2 : rechitsAndChi2) 
            {
                ...
                //centering beased on adc charges
...
DEFINE_FWK_MODULE(DebugPixelHitsCluREF_v1);
