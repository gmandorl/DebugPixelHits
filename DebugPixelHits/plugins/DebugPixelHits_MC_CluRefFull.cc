...
class DebugPixelHits_MC_CluRefFull : public edm::one::EDAnalyzer<edm::one::SharedResources> {
    public:
        explicit DebugPixelHits_MC_CluRefFull(const edm::ParameterSet&);
        ~DebugPixelHits_MC_CluRefFull();
...
//
DebugPixelHits_MC_CluRefFull::DebugPixelHits_MC_CluRefFull(const edm::ParameterSet& iConfig):
...
DebugPixelHits_MC_CluRefFull::~DebugPixelHits_MC_CluRefFull()
{
}

    void
DebugPixelHits_MC_CluRefFull::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    using namespace edm;
    run_  = iEvent.id().run();
...
DEFINE_FWK_MODULE(DebugPixelHits_MC_CluRefFull);
