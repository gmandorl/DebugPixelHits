...
process.clusterInfo = cms.EDAnalyzer("DebugPixelHits_MC_pT2GeV",
...
if False:
    ...
    process.TFileService = cms.Service("TFileService", fileName = cms.string("debugHits_MC_TT_andBrokenCenter.root"))
