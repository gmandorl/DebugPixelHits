...
numpy.savez(sys.argv[1].split(".")[0]+"full_cluster", track=track, track1=track1, image=image, hit_pos=hit_pos, delta_TH=delta_TH, track_pos=track_pos, Truth_image=Truth_image,
