...
process.clusterInfo = cms.EDAnalyzer("DebugPixelHits_MC_CluRef_AddHit",
...
if True:
    ...
    process.TFileService = cms.Service("TFileService", fileName = cms.string("debugHits_MC_Test.root"))
