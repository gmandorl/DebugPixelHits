...
process.clusterInfo = cms.EDAnalyzer("DebugPixelHits_TTbar",
...
if True:
    ...
    process.TFileService = cms.Service("TFileService", fileName = cms.string("debugHits_MC_TrackCenter_andBrokenCenter.root"))
